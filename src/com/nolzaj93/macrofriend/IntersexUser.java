...
/**
 * This class is a subclass/derived class/child class of NewUser. The only method different for an
 * intersex user compared to a female or male user is estimateBasalMetabolicRate().
 *
 * @author Austin Nolz
 */
